    ...
    <div className="w-full ">
      ...
      <div className="relative">
        ...
        <div className="flex justify-center">
          <div className="w-full">
            <div
              className="flex gap-[20px] xs:gap-[25px] sm:gap-[30px] md:gap-[40px] lg:gap-[50px] xl:gap-[55px] 2xl:gap-[60px] 3xl:gap-[64px] transition-transform duration-500 ease-out"
              ...
              {slides.map(({ image, title = "", description = "" }, index) => (
                <div key={index} className="w-full">
                  {second ? (
                    ...
                    <div
                      className={`w-full xs:w-full sm:w-full md:w-[600px] lg:w-[650px] xl:w-[700px] 2xl:w-[750px] 3xl:w-[816px] h-[300px] xs:h-[350px] sm:h-[400px] md:h-[450px] lg:h-[500px] xl:h-[520px] 2xl:h-[540px] 3xl:h-[558px] ${
                        second ? "" : "bg-gray-100"
                      }`}
                    >
                      <div
                        className={`h-[150px] xs:h-[170px] sm:h-[190px] md:h-[210px] lg:h-[230px] xl:h-[250px] 2xl:h-[260px] 3xl:h-[272px] w-full mb-[15px] xs:mb-[18px] sm:mb-[20px] md:mb-[25px] lg:mb-[28px] xl:mb-[30px] border-b border-b-gray-400 ${
                          index === 1
                      ...
                      <div className="px-[20px] xs:px-[25px] sm:px-[30px] md:px-[35px] lg:px-[40px] xl:px-[45px] pb-[30px] xs:pb-[35px] sm:pb-[40px] md:pb-[45px] lg:pb-[50px] xl:pb-[52px]">
                        ...
                        />
                        <p className="text-base xs:text-base sm:text-lg text-gray-400 leading-[18px] xs:leading-[19px] sm:leading-[20px] md:leading-[21px] lg:leading-[22px] xl:leading-[23px]">
                          {description}
                        </p>
                      </div>
                    </div>
