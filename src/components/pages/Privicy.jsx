...
const privacyPolicyData = [
  {
    ...
    content: [
      ...
      "1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://recensa.nilit1.ru/.",
    ],
  },
  {
    id: 2,
    ...
    content: [
      ...
      "2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://recensa.nilit1.ru/.",
      ...
      "2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://recensa.nilit1.ru/.",
      "2.9. Персональные данные, разрешенные субъектом персональных данных для распространения, — персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных (далее — персональные данные, разрешенные для распространения).",
      "2.10. Пользователь — любой посетитель веб-сайта https://recensa.nilit1.ru/.",
  ...
  },
  {
    id: 7,
    title:
      "7. Цели обработки персональных данных. Условия обработки персональных данных",
    content: [
  ...
  },
  {
    ...
    content: [
      ...
      "12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://recensa.nilit1.ru/privicy.",
    ],
  },
];
...
export default function PrivicyPage() {
  ...
  const renderContent = (content) => {
    return content.map((paragraph, index) => (
      <p key={index} className="text-gray-400 text-md sm:text-lg mb-5">
        {paragraph}
      </p>
    ));
  };
  ...
  const renderListItems = (items) => {
    return items.map((item, index) => (
      <li key={index} className="text-gray-400 text-md sm:text-lg mb-5">
        — {item}
      </li>
    ));
  };
  ...
  const renderSubSections = (subSections) => {
    return subSections.map((subSection, index) => (
      <div key={index} className="mb-8">
        {subSection.title && (
          <h4 className="text-md sm:text-lg text-gray-400 pb-6">
            {subSection.title}
          </h4>
        )}
        {subSection.listItems && (
          <ul className="text-gray-400 text-md sm:text-lg space-y-5 mb-8">
            {renderListItems(subSection.listItems)}
          </ul>
        )}
  ...
  const renderTable = (tableData) => {
    return (
      <div className="overflow-x-auto mb-8">
        <table className="w-full border-collapse border border-gray-300 text-gray-400 text-md sm:text-lg">
          <thead>
            <tr>
  ...
  // Main render function for policy sections
  const renderPolicySection = (section) => {
    return (
      <div key={section.id} className="mb-10">
        ...
        {section.content && (
          <div className="text-gray-400 text-md sm:text-lg space-y-5 mb-6">
  ...
  return (
    <>
      <SeoBlock
        url={"https://recensa.nilit1.ru/privicy"}
      ...
      <Helmet>
        ...
        <meta property="og:url" content={"https://recensa.nilit1.ru/privicy"} />
        <meta name="keywords" content={"политика конфиденциальности"} />
        <link rel="canonical" href={"https://recensa.nilit1.ru/privicy"} />
      </Helmet>
      ...
      <div className="container px-3 sm:px-0 ">
        <nav className="mb-4 xs:mb-5 sm:mb-6">
          ...
          >
            ...
            >
              <a title="Подраздел уровня 1">
                <span itemProp="name">Политика конфиденциальности</span>
                <meta itemProp="position" content="1" />
                <meta
                  itemProp="item"
                  content="https://recensa.nilit1.ru/privicy"
                />
              </a>
            </li>
          </ul>
