...
import { T as Title, b as changeShowStatus, O as changeOrderNumber, P as changeRoutingToOrders, y as changeIsAdmin, g as getAllOrders, v as SeoBlock, F as Footer } from "../entry-server.js";
...
function ProductItem({ list }) {
  ...
  return currentProduct ? /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      SeoBlock,
      {
