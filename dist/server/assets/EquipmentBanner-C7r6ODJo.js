import { u as useDispatch, h as useLocation, a as useSelector, j as jsxRuntimeExports, B as Button, c as changeShowPopup } from "./index-D-mRqp05.js";
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          z-[-2] ${imageSrc === placeholderSrc ? "loading" : "loaded"} ${isProduct ? `object-contain h-[400px] md:h-[500px] lg:h-[600px] 
              ...
              max-h-[900px]`}`,
                  src: imageSrc,
                  alt: product ? product?.image_banner_alt : isEquipment ? "Баннер оборудования" : "Баннер решений",
                  title: product ? product?.image_banner_alt : isEquipment ? "Баннер оборудования" : "Баннер решений"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
