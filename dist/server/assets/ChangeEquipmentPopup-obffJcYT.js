...
import {
  f as changeEquipmentPopup,
  a as changeItemId,
  u as updateEquipment,
  h as updateSolutions,
  i as updateNews,
  ...
  const [formData, setFormData] = useState(() => {
    const baseData = isNews
      ? {
          ...
          page_description:
            (findProduct == null ? void 0 : findProduct.page_description) || "",
          page_title:
            (findProduct == null ? void 0 : findProduct.page_title) || "",
          page_keywords:
            (findProduct == null ? void 0 : findProduct.page_keywords) || "",
          hidden_seo_text:
            (findProduct == null ? void 0 : findProduct.hidden_seo_text) || "",
        }
      : isSolutions
      ? {
          name: (findProduct == null ? void 0 : findProduct.name) || "",
          description:
            (findProduct == null ? void 0 : findProduct.description) || "",
          sub_header:
            (findProduct == null ? void 0 : findProduct.sub_header) || "",
          header: (findProduct == null ? void 0 : findProduct.header) || "",
          image_banner_alt:
            (findProduct == null ? void 0 : findProduct.image_banner_alt) || "",
          image_card_alt:
            (findProduct == null ? void 0 : findProduct.image_card_alt) || "",
          page_description:
            (findProduct == null ? void 0 : findProduct.page_description) || "",
          page_title:
            (findProduct == null ? void 0 : findProduct.page_title) || "",
          page_keywords:
            (findProduct == null ? void 0 : findProduct.page_keywords) || "",
          extra_description:
            (findProduct == null ? void 0 : findProduct.extra_description) ||
            "",
          hidden_seo_text:
            (findProduct == null ? void 0 : findProduct.hidden_seo_text) || "",
        }
      : {
          ...
          description:
            (findProduct == null ? void 0 : findProduct.description) || "",
          min_param:
            (findProduct == null ? void 0 : findProduct.min_param) || "",
          max_param:
            (findProduct == null ? void 0 : findProduct.max_param) || "",
          sub_header:
            (findProduct == null ? void 0 : findProduct.sub_header) || "",
          header: (findProduct == null ? void 0 : findProduct.header) || "",
          image_banner_alt:
      ...
      if (!isNews) {
        ...
        if (isEquipment) {
          const equipmentData = {
            ...
            image_banner_alt:
              formData == null ? void 0 : formData.image_banner_alt,
            image_card_alt: formData == null ? void 0 : formData.image_card_alt,
            extra_description:
              formData == null ? void 0 : formData.extra_description,
            page_description:
              formData == null ? void 0 : formData.page_description,
            page_title: formData == null ? void 0 : formData.page_title,
            page_keywords: formData == null ? void 0 : formData.page_keywords,
            hidden_seo_text:
              formData == null ? void 0 : formData.hidden_seo_text,
          };
          await dispatch(
            updateEquipment({
              id: findProduct == null ? void 0 : findProduct.id,
              data: equipmentData,
            })
          ).unwrap();
        } else if (isSolutions) {
  ...
  return /* @__PURE__ */ jsx("section", {
    ...
    children: /* @__PURE__ */ jsxs("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("h2", {
          className:
            "text-center text-[32px] font-medium leading-[40.8px] text-gray-400 mb-6",
          children: isNews
            ? "Изменить новость"
            : isSolutions
            ? "Изменить решения"
          ...
          children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                children: [
                  /* @__PURE__ */ jsx("p", {
                    ...
                    children: "Изображение для баннера",
                  }),
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("p", {
                        className: "w-full text-sm text-gray-900",
                        children: "Alt-тег для баннера",
                      }),
                      /* @__PURE__ */ jsx(Input, {
                        type: "text",
                        name: "image_banner_alt",
                        className:
                          "block p-2.5 w-full text-base text-gray-400 font-normal bg-gray-50 rounded-lg border border-gray-300",
            ...
            /* @__PURE__ */ jsxs("div", {
              children: [
                /* @__PURE__ */ jsx("p", {
                  className: "w-full text-sm text-gray-900",
                  children: "Изображение для карточки",
                }),
                /* @__PURE__ */ jsx(ImageUploader, {
                  findProduct,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx(JoditEditor, {
                        ref: textEditorRef,
                        value: formData.text,
                        config,
                        onBlur: (content) =>
                          handleEditorChange(content, "text"),
                      }),
                    ],
                  }),
                ],
              ...
              /* @__PURE__ */ jsxs(Fragment, {
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("p", {
                        className: "w-full text-sm text-gray-900 pt-4",
                        children: "Заголовок баннера",
                      }),
                      /* @__PURE__ */ jsx(Input, {
                        type: "text",
                        name: "sub_header",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("p", {
                        className: "w-full text-sm text-gray-900",
                        children: "Максимальный параметр",
                      }),
                      /* @__PURE__ */ jsx(Input, {
                        type: "text",
                        name: "max_param",
            ...
            /* @__PURE__ */ jsxs("div", {
              className: "border-t border-gray-200 pt-4 space-y-[18px]",
              children: [
                /* @__PURE__ */ jsx("h3", {
                  className: "text-lg font-medium text-gray-900",
                  children: "SEO информация",
                }),
                /* @__PURE__ */ jsxs("div", {
                  className: "space-y-2",
                  children: [
                    /* @__PURE__ */ jsx("p", {
                      className: "w-full text-sm text-gray-900",
                      children: "Заголовок страницы (Title)",
                    }),
                    /* @__PURE__ */ jsx(Input, {
                      type: "text",
                      name: "page_title",
                ...
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("p", {
                      className: "w-full text-sm text-gray-900",
                      children: "Описание страницы (Description)",
                    }),
                ...
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("p", {
                      className: "w-full text-sm text-gray-900",
                      children: "Текст для поисковых систем",
                    }),
                    /* @__PURE__ */ jsx("textarea", {
                      ...
                      placeholder:
                        "Этот текст предназначен для поисковых систем и не виден пользователям. ",
                    }),
                  ],
                }),
                /* @__PURE__ */ jsxs("div", {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("p", {
                      className: "w-full text-sm text-gray-900",
                      children: "Ключевые слова (Keywords)",
                    }),
                    /* @__PURE__ */ jsx(Input, {
                      type: "text",
                      name: "page_keywords",
            ...
            /* @__PURE__ */ jsx("button", {
              type: "submit",
              className:
                "w-full p-3 bg-gray-400 text-white rounded hover:bg-[#2F2F2F] transition-colors text-lg font-medium",
              children: "ИЗМЕНИТЬ",
            }),
          ],
        }),
...
export { ChangeEquipmentPopup as default };
