...
const slidesMain = [
  {
    ...
    description: "Уверенность в качестве и надежности: строгий контроль качества на всех этапах производства."
  },
  {
    image: "/img/slider_2.jpg",
    description: "Свобода и контроль: индивидуальная конфигурация оборудования под ваши нужды."
  },
  {
    image: "/img/slider_3.jpg",
    description: "Экономия времени и ресурсов: оптимизация процессов проектирования и интеграции."
  },
  {
    image: "/img/slider_4.jpg",
    description: "Снижение эксплуатационных расходов: высокая энергоэффективность и долговечность оборудования."
  },
  {
    image: "/img/slider_5.jpg",
    description: "Партнёрские отношения на основе доверия и поддержки: мы предоставляем поддержку на каждом этапе проекта."
  }
];
const recensaAbout = [
