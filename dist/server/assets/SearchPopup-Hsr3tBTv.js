...
import { q as useLatinFormat, B as Button, r as changeShowSearchPopup } from "../entry-server.js";
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-2 xs:mt-3 sm:mt-4 flex justify-center ", children: searchData.length > 0 ? /* @__PURE__ */ jsx("div", { className: " grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-3 xs:gap-4 sm:gap-5", children: searchData.map(
          ({ image_card, name, description, id, max_param }, i) => /* @__PURE__ */ jsxs(
            ...
            {
              onClick: () => handleClose(),
              to: max_param ? `/equipment/${useLatinFormat(name)}` : `/solutions/${useLatinFormat(name)}`,
        ...
        ) }) : /* @__PURE__ */ jsx("div", { className: "w-full h-[60vh] flex-center justify-center ", children: /* @__PURE__ */ jsx("p", { className: "text-gray-400 text-center", children: "По вашему запросу ничего не найдено" }) }) })
      ]
    }
  ) });
}
