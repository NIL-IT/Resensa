        ...
        /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: list.map((item, i) => /* @__PURE__ */ jsx(
              "article",
              {
                className: `flex-center justify-center lg:justify-start mt-2 xl:mt-3  ${i === 4 ? "w-[150px]  xl:w-[200px] 2xl:w-[250px] 3xl:w-[300px]" : "w-[100px]  xl:w-[130px] 2xl:w-[140px] 3xl:w-[150px]"}"
                }`,
