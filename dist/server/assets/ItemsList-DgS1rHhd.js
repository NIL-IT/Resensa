...
import { T as Title, B as Button, t as useLatinFormat, O as getEquipmentById, P as changeSolutionsId, Q as getSolutionsById, U as changeEquipmentId, a as changeItemId, c as changeShowPopup } from "../entry-server.js";
...
function ItemsList({
  ...
  useEffect(() => {
    const priceValidUntil = /* @__PURE__ */ new Date();
          ...
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("meta", { itemProp: "priceValidUntil", content: formattedPriceValidUntil }),
                /* @__PURE__ */ jsx(
                  "link",
                  {
                    itemProp: "url",
