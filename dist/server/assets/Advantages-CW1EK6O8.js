...
function Advantages() {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "overflow-x-hidden w-full bg-gray-400 py-[40px] xs:py-[40px] sm:py-[40px] md:py-[40px] lg:py-[40px] xl:py-[40px] 2xl:py-[40px] ", children: [
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          list.map(({ title, text, subtitle, img }, i) => /* @__PURE__ */ jsxs(
            "article",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "max-w-[130px] max-h-[130px]", children: /* @__PURE__ */ jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("h3", { className: " text-base uppercase xs:text-base sm:text-lg md:text-xl   text-white max-w-[260px] xs:max-w-[270px] sm:max-w-[280px] md:max-w-[300px]", children: title }),
                      subtitle && /* @__PURE__ */ jsx("h3", { className: "text-base uppercase xs:text-base sm:text-lg md:text-xl   text-white max-w-[260px] xs:max-w-[270px] sm:max-w-[280px] md:max-w-[300px]", children: subtitle })
                    ]
                  }
                ),
                /* @__PURE__ */ jsx("p", { className: "text-gray-100 text-sm xs:text-sm sm:text-base md:text-lg  leading-[20px] xs:leading-[21px] sm:leading-[22px] md:leading-[25.5px] lg:leading-[26px] xl:leading-[26.5px] 2xl:leading-[27px] 3xl:leading-[27.5px] max-w-[330px] xs:max-w-[340px] sm:max-w-[350px] md:max-w-[370px]", children: text })
              ]
            },
            `first-${i}`
          )),
