...
function AdminOrders({ title }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full relative", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "min-h-[500px]  lg:min-h-[auto] max-h-[480px] overflow-x-auto overflow-y-scroll  scrollbar-hide", children: /* @__PURE__ */ jsxs("table", { id: "tableId", className: "min-w-full relative", children: [
      ...
      loading ? /* @__PURE__ */ jsx("tbody", { children: /* @__PURE__ */ jsx("tr", { className: "border-b *:text-sm *:font-normal *:text-gray-400", children: /* @__PURE__ */ jsx("td", { colSpan: "7", className: "py-3 px-4 text-center", children: "Загрузка..." }) }) }) : ordersList.length > 0 ? /* @__PURE__ */ jsx("tbody", { children: ordersList.map((order) => /* @__PURE__ */ jsxs(
        "tr",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("td", { className: " py-2 xl:py-3 px-1 xl:px-4", children: useFormatDate(order.date) }),
