...
import { w as changeStatusOrderPopup, a as changeItemId, d as changeAddOrderPopup, T as Title, g as getAllOrders, x as deleteOrders, y as changeIsAdmin, B as Button, f as changeEquipmentPopup, z as deleteEquipment, n as getAllEquipment, A as deleteSolutions, p as getAllSolutions, j as changeShowAddNewItemPopup, C as importOrdersExcel, D as getBanner, E as updateBanner, G as deleteNews, l as getAllNews, H as getCompany, I as updateCompany, J as updateHomeSeo, K as updateContactsSeo, L as updateEquipmentSeo, M as updateSolutionSeo, F as Footer, N as exportOrdersExcel } from "../entry-server.js";
import { Plus, PencilLine, Trash2, FileSpreadsheet, ChevronDown, X, Menu } from "lucide-react";
import { useDispatch, useSelector } from "react-redux";
import { S as SearchInput } from "./SearchInput-DWJXmJ0k.js";
...
function Admin() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Helmet, { children: /* @__PURE__ */ jsx("title", { children: "Личный кабинет" }) }),
