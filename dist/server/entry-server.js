...
import { lazy, useState, useRef, useEffect, StrictMode } from "react";
...
lazy(() => import("./assets/Home-DVddwTFM.js"));
lazy(() => import("./assets/NotFound-BgsE9Uif.js"));
lazy(() => import("./assets/Equipment-OVpJ8OaT.js"));
lazy(() => import("./assets/AboutCompany-D_EVY5ao.js"));
lazy(() => import("./assets/Admin-CII8Ay9f.js"));
lazy(() => import("./assets/ProductItem-BIg0qCOq.js"));
lazy(() => import("./assets/LoginForm-DP8JAukR.js"));
lazy(() => import("./assets/Contacts-Bz7sO4JH.js"));
lazy(() => import("./assets/NewsPage-DMvXJRJN.js"));
lazy(() => import("./assets/Popup-DNVRrJrb.js"));
lazy(() => import("./assets/StatusPopup-DpOKn9Y7.js"));
lazy(
  () => import("./assets/AddOrderPopup-Baelmd6M.js")
);
lazy(
  () => import("./assets/ChangeEquipmentPopup-Cbj3MZlG.js")
);
lazy(() => import("./assets/AddNewItem-C1HeiZRd.js"));
lazy(() => import("./assets/SearchPopup-BQG4M_ej.js"));
function App() {
  ...
  return !loading ? /* @__PURE__ */ jsx("div", { className: "relative" }) : /* @__PURE__ */ jsx("div", { className: "fixed top-0 left-0  z-50 bg-white min-w-[100vw] min-h-[100vh] flex-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "loader" }) });
}
