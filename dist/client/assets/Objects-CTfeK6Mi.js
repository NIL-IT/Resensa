...
import{r as s,j as e,_ as h}from"./three-vendor-BeAgAJS5.js";import{T as g,B as u}from"./index-BSOPENtf.js";const f=dynamic(()=>h(()=>import("./EarthScene-B3DHCmAo.js"),__vite__mapDeps([0,1,2])),{ssr:!1,loading:()=>e.jsx("div",{className:"w-500 h-500 bg-gray-500 animate-pulse rounded-full"})}),w=[{name:"Административные объекты",id:1},{name:"Производства",id:2},{name:"Медицина и фармацевтика",id:3}];function j({className:a=null,about:p=!1}){const[n,m]=s.useState(0),[x,r]=s.useState(!1),[l,o]=s.useState(!1),d=t=>m(t);return s.useEffect(()=>{o(!0),r(!0)},[]),s.useEffect(()=>{if(!l)return;const t=()=>{x||r(!0)};return window.addEventListener("resize",t),t(),()=>{window.removeEventListener("resize",t)}},[x,l]),e.jsx("section",{className:`w-full bg-gray-400 py-12 sm:py-16 md:py-20 lg:py-24 ${p?"mt-[0px] xs:mt-[28px] md:mt-[160px] lg:mt-[225px] xl:mt-[205px] 2xl:mt-[220px] 3xl:mt-[225px]":""} ${a}`,children:e.jsx("div",{className:"earth_container relative max-w-[full] min-h-[500px] sm:min-h-[550px] md:min-h-[550px] lg:min-h-[602px] xl:min-h-[650px] 2xl:min-h-[702px] flex flex-col justify-center",children:e.jsxs("div",{className:`flex-center flex-col \r
 ...
 \r
       ...
       `,children:l&&x&&e.jsx(f,{index:n})})]})})})}export{j as O};
