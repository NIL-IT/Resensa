...
import { j as jsxRuntimeExports } from "./three-vendor-CLIGOdvC.js";
import { u as useDispatch, E as useNavigate, a as useSelector, L as Link, B as Button, c as changeShowPopup, _ as changeRoutingToOrders, a2 as changeEquipmentId, a0 as changeSolutionsId, x as useLatinFormat } from "./index-aArvgGxB.js";
const navList = [
  { name: "Главная", path: "/" },
...
function Footer({ scrollTop = null }) {
  ...
  const handleClickLink = (i, path) => __async(this, null, function* () {
    if (!isAdmin && +i == 4) {
      yield dispatch(changeRoutingToOrders(true));
