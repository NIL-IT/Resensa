...
import { u as useDispatch, h as useLocation, T as Title, B as Button, L as Link, x as useLatinFormat, $ as getEquipmentById, a0 as changeSolutionsId, a1 as getSolutionsById, a2 as changeEquipmentId, b as changeItemId, c as changeShowPopup } from "./index-aArvgGxB.js";
function ItemsList({
  limited = true,
  list,
  href,
  ...
  const [lim, setLim] = reactExports.useState(limited);
  const [visibleItems, setVisibleItems] = reactExports.useState([]);
  const [hiddenItems, setHiddenItems] = reactExports.useState([]);
  ...
  const handleClickItem = (id) => __async(this, null, function* () {
    if (equipment) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { itemProp: "brand", content: "Recensa" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { itemProp: "sku", content: id }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { itemProp: "availability", content: "https://schema.org/InStock" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "link",
                  {
                    itemProp: "url",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-center justify-between gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
  ...
  return visibleItems.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container py-12 xs:py-14 sm:py-16 md:py-18 lg:py-20 xl:py-20 2xl:py-20 3xl:py-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { itemScope: true, itemType: "https://schema.org/ItemList", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Title,
        {
          itemProp: "name",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { itemProp: "numberOfItems", content: list ? list.length : 0 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center w-full transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-8", children: visibleItems.map((item, index) => renderItem(item, index)) }) })
    ] }),
    lim && hiddenItems.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
