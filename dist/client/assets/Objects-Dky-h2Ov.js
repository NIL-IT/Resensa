...
import { j as jsxRuntimeExports, C as Canvas, O as OrbitControls, r as reactExports, u as useTexture, b as useFrame, a as React, H as Html } from "./three-vendor-CLIGOdvC.js";
import { T as Title, B as Button } from "./index-aArvgGxB.js";
...
function LocationMarker({
  ...
  const [clickState, setClickState] = reactExports.useState(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { position, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("sphereGeometry", { args: [0.014, 16, 16] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("meshBasicMaterial", { color: "#4a90e2" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Html,
      {
        ...
        distanceFactor: 6,
        occlude: true,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start pt-1 relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          clickState === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              target: "_blank",
              href: mapUrl,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-tight", children: description }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-300 text-[6px] mt-1", children: "Нажмите еще раз для открытия карты" })
              ]
            }
          )
        ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "group",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("directionalLight", { position: [200, 200, 200], intensity: 0.7, castShadow: true }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "directionalLight",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: earthRef, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("sphereGeometry", { args: [1.8, 64, 64] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("sphereGeometry", { args: [1.85, 64, 64] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("meshBasicMaterial", { color: "#3a85ff", transparent: true, opacity: 0.03 })
        ] })
      ]
    }
  );
    ...
    "article",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Canvas,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Earth, { index }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              OrbitControls,
              {
                enableZoom: false,
...
function Objects({ className = null, about = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "earth_container  relative max-w-[full] min-h-[500px] sm:min-h-[550px] md:min-h-[550px] lg:min-h-[602px] xl:min-h-[650px] 2xl:min-h-[702px] flex flex-col justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: " max-w-[411px]", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white border border-white divide-y divide-white w-full  ", children: list.map(({ name, id }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(EarthScene, { index })
              }
            )
          ]
        }
