      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: list.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "article",
              {
...
function Slider({ slides, second, recensaAbout: recensaAbout2 }) {
  ...
  const [width, setWidth] = reactExports.useState(currentWidth);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "min-w-[100wh] mb-10 xs:mb-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-[100wh] overflow-hidden ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: " flex gap-0  \r\n              xl:gap-[55px] 2xl:gap-[60px] 3xl:gap-[64px] \r\n              transition-transform duration-500 ease-out",
        style: { transform: `translateX(-${setTranslate()}%)` },
        children: slides.map(({ image, title = "", description = "" }, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "w-full min-w-full flex justify-center xl:block xl:min-w-[auto]\r\n                   3xl:min-w-[auto]  \r\n                   2xl:h-auto  xs:w-full    ",
            children: second ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-[20px] xs:px-[25px] sm:px-[30px] md:px-[35px] lg:px-[40px] xl:px-[45px] pb-[30px] xs:pb-[35px] sm:pb-[40px] md:pb-[45px] lg:pb-[50px] xl:pb-[52px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 uppercase text-md xs:lg sm:text-xl ", children: description }) })
                  ]
                }
              )
            )
...
function SliderPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full xs:w-full sm:w-full md:w-[800px] lg:w-[900px] xl:w-[1000px] 2xl:w-[1100px] 3xl:w-[1160px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h3",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-10 ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { recensaAbout, slides, second })
  ] });
}
export {
  Partners as P,
