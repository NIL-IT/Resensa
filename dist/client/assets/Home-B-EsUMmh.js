import { j as jsxRuntimeExports, r as reactExports } from "./three-vendor-CLIGOdvC.js";
import { w as cn, u as useDispatch, B as Button, c as changeShowPopup, T as Title, L as Link, x as useLatinFormat, h as useLocation, y as api, b as changeItemId, R as ROUTES } from "./index-aArvgGxB.js";
...
import { S as SliderPage, P as Partners } from "./SliderPage-DkuG-H0z.js";
...
function Banner({ banner }) {
  ...
  const [imageSrc, setImageSrc] = reactExports.useState(imgPlaceholder);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-center flex-col lg:flex-row justify-between mt-3 xs:mt-3.5 sm:mt-4 md:mt-4 lg:mt-4 xl:mt-4 2xl:mt-4 3xl:mt-4 gap-6 xs:gap-7 sm:gap-8 lg:gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-6 xs:gap-7 sm:gap-8 md:gap-[60px] lg:gap-[70px] xl:gap-[75px] 2xl:gap-[80px] 3xl:gap-[88px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: " xs:gap-5 block md:w-[290px] xl:w-[312px]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
...
вентиляционного оборудования`
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block xs:gap-5  md:w-[280px] xl:w-[312px]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
...
на продукцию компании.`
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mr-5 xs:mr-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mr-5 xs:mr-0 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
...
function News({ news }) {
  useDispatch();
  const [isLimited, setLimited] = reactExports.useState(true);
  const [newsData, setNewsData] = reactExports.useState(news);
  reactExports.useEffect(() => {
    setNewsData(news);
  }, [news]);
  reactExports.useEffect(() => {
  ...
  return newsData.length ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      itemScope: true,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center  w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex-center flex-col mx-auto justify-center   md:w-[800px] lg:w-[900px] xl:w-[1000px] 2xl:w-[1178px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid  grid-cols-1  lg:grid-cols-2  2xl:grid-cols-3 gap-8", children: newsData.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: " flex flex-col justify-between h-full pt-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { itemProp: "author", content: "Resenca" }),
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { itemProp: "url image", src: "/logo.svg" })
                            }
                          ),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { itemProp: "dateModified", content: `${item.date}` }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "meta",
                      {
                        itemScope: true,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-[10px] xs:pt-[11px] sm:pt-[12px] md:pt-[13px] lg:pt-[14px] pb-3 xs:pb-3.5 sm:pb-4 md:pb-4.5 lg:pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-800 text-sm xs:text-sm sm:text-base", children: item.date.split("T")[0] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "flex-center gap-3 group-hover:gap-4 transition-all", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-base xs:text-base sm:text-lg font-normal", children: "Читать" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "img",
                        {
          ...
          isLimited && news.length > 6 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center w-[300px] sm:w-[350px] lg:w-[756px] xl:w-[766px] 2xl:w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              onClick: () => handleClick(),
...
function Home({ equipment, solutions, banner, news, company }) {
  ...
  const isNavigateNews = api.get("news_nav") === "1";
  const dispatch = useDispatch();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Banner, { banner }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ItemsList, { equipment: false, list: solutions, href: ROUTES.SOLUTIONS }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SliderPage,
        {
          title: "о компании",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(News, { news }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Partners, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Objects, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, { scrollTop })
  ] });
}
export {
  Home as default
