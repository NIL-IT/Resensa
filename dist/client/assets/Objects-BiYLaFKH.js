...
import{r as s,j as e,_ as g}from"./three-vendor-BeAgAJS5.js";import{T as f,B as w}from"./index-DY_UiZsC.js";import"./react-vendor-DomL0yj5.js";const b=s.lazy(()=>g(()=>import("./EarthScene-ZHzSBlaE.js"),__vite__mapDeps([0,1,2]))),y=[{name:"Административные объекты",id:1},{name:"Производства",id:2},{name:"Медицина и фармацевтика",id:3}];function E({className:a=null,about:m=!1}){const[n,o]=s.useState(0),[c,d]=s.useState(0),[x,i]=s.useState(!1),[l,h]=s.useState(!1);s.useEffect(()=>{const t=setTimeout(()=>{d(r=>r+1)},2e3);return()=>clearTimeout(t)},[]);const u=t=>o(t);return s.useEffect(()=>{h(!0),i(!0)},[]),s.useEffect(()=>{if(!l)return;const t=()=>{x||i(!0)};return window.addEventListener("resize",t),t(),()=>{window.removeEventListener("resize",t)}},[x,l]),c!==0&&e.jsx("section",{className:`w-full bg-gray-400 py-12 sm:py-16 md:py-20 lg:py-24 ${m?"mt-[0px] xs:mt-[28px] md:mt-[160px] lg:mt-[225px] xl:mt-[205px] 2xl:mt-[220px] 3xl:mt-[225px]":""} ${a}`,children:e.jsx("div",{className:"earth_container relative max-w-[full] min-h-[500px] sm:min-h-[550px] md:min-h-[550px] lg:min-h-[602px] xl:min-h-[650px] 2xl:min-h-[702px] flex flex-col justify-center",children:e.jsxs("div",{className:`flex-center flex-col \r
 ...
 \r
       ...
       `,children:l&&x&&e.jsx(b,{index:n})})]})})})}export{E as default};
