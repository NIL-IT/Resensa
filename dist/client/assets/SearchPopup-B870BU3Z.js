...
import { a as useSelector, u as useDispatch, L as Link, B as Button, v as changeShowSearchPopup } from "./index-aArvgGxB.js";
...
function SearchPopup() {
  ...
  const [searchData, setSearchData] = reactExports.useState([...equipment, ...solutions]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "h-[80%] min-w-[80%] fixed inset-0 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 xs:mt-3 sm:mt-4 flex justify-center ", children: searchData.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: " grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-3 xs:gap-4 sm:gap-5", children: searchData.map(
          ({ image_card, name, description, id, max_param }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              onClick: () => handleClose(),
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-gray-400 text-xs xs:text-sm uppercase font-normal my-1 xs:my-1.5 sm:my-2", children: name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] xs:text-[12px] sm:text-[13px] text-gray-300 line-clamp-3", children: description })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
        ...
        ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-[60vh] flex-center justify-center ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400", children: "По вашему запросу ничего не найдено" }) }) })
      ]
    }
  ) });
}
